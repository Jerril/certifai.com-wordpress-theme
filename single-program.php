                                            ...
                                            if(!empty($segment_courses)){
                                              ...
                                              ?>
                                                <div class="col-lg-3 col-md-6 my-2">
                                                  <a data-toggle="modal" data-target="#modalMSCEnrollment<?php echo $in; ?>" class="boxlink">
                                                ...
                                                <?php
                                                  if(($course['msc_open_popup']??'') == "yes"){ ?>
                                                    <div class="modal fade modal-full-screen" id="modalMSCEnrollment<?php echo $in; ?>" data-backdrop="static" data-keyboard="false">
                                                      <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                                        <div class="modal-content mb-5">
                                                          <div class="modal-header headerbg px-md-5 px-3 py-md-1 py-1">
                                                            <div class="mx-1 ml-auto">
